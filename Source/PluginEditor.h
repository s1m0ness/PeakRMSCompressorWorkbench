...
/**
*/
class PeakRMSCompressorWorkbenchAudioProcessorEditor  : public juce::AudioProcessorEditor
{
public:
    PeakRMSCompressorWorkbenchAudioProcessorEditor (PeakRMSCompressorWorkbenchAudioProcessor&);
